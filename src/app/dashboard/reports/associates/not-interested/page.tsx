...
const AssociateNotInterestedLeadsPage = () => {
  ...
  return (
    <div className="flex flex-col gap-6">
        <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold">Not Interested Leads (Associate)</h1>
            <Link href="/dashboard/users/associates">
...
export default AssociateNotInterestedLeadsPage;
