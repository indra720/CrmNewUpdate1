...
const kpiData = [
    ...
    { title: "Interested", valueKey: "interested", icon: Check, color: "text-teal-500", link: "/dashboard/reports/interested" },
    { title: "Not Interested", valueKey: "not_interested", icon: XCircle, color: "text-red-500", link: "/dashboard/reports/not-interested" },
    { title: "Other Location", valueKey: "other_location", icon: MapPin, color: "text-orange-500", link: "/dashboard/reports/other-location" },
    { title: "Not Picked", valueKey: "not_picked", icon: Phone, color: "text-slate-500", link: "/dashboard/reports/not-picked" },
