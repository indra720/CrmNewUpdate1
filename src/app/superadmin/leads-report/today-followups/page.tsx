...
export default function TodayFollowupsPage() {
  ...
  async function fetchLeads() {
    ...
    try {
      ...
      const data = await getTeamCustomerLeads('today_follow', search, formattedStartDate, formattedEndDate); 
        ...
        <Dialog open={showModal} onOpenChange={setShowModal} >
          <DialogContent className="w-[95vw] sm:max-w-md p-4 max-h-[90vh] flex flex-col rounded-md">
            <DialogHeader className="flex-shrink-0">
              ...
              <DialogDescription>
                Update the status and follow-up details for this lead.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="grid gap-4 p-4 overflow-y-auto flex-1">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="Enter a message or notes..."
                />
              </div>
            </div>
