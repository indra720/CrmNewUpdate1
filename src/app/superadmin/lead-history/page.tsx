...
export default function LeadHistoryPage() {
  ...
  useEffect(() => {
    if (leadId) {
      ...
      fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/accounts/leads-history/?lead_id=${leadId}`, {
        headers: {
        ...
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="outline" size="icon" onClick={() => router.push('/superadmin/leads-report/interested')}>
