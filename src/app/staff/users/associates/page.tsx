...
const kpiData = [
    { title: "Total Visit", valueKey: "total_visit", icon: Eye, color: "text-blue-500", link: "/staff/reports/associates/visit" },
    { title: "Interested", valueKey: "interested", icon: Check, color: "text-green-500", link: "/staff/reports/associates/interested" },
    { title: "Not Interested", valueKey: "not_interested", icon: XCircle, color: "text-red-500", link: "/staff/reports/associates/not-interested" },
    { title: "Other Location", valueKey: "other_location", icon: MapPin, color: "text-yellow-500", link: "/staff/reports/associates/other-location" },
    { title: "Not Picked", valueKey: "not_picked", icon: Phone, color: "text-purple-500", link: "/staff/reports/associates/not-picked" },
