                        ...
                        <TableRow key={user.id}>
                          ...
                          <TableCell>
                              <select className="form-select form-select-sm w-full bg-background border border-input rounded-md px-2 py-1 text-sm" onChange={(e) => e.target.value && window.location.assign(e.target.value)}>
                                  ...
                                  <option value={`/staff/reports/interested`}>Intrested</option>
                                  <option value={`/staff/reports/not-interested`}>Not Interested</option>
                                  <option value={`/staff/reports/other-location`}>Other Location</option>
                                  <option value={`/staff/reports/total-leads`}>Lost</option>
                                  <option value={`/staff/reports/visit`}>Visit</option>
                              </select>
                          </TableCell>
