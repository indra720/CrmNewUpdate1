...
function StaffNotPickedLeadsPage() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/accounts/api/staff/not-picked-leads/`, {
          method: "GET",
          headers: {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-4">
        <BackButton />
        {/* <h1 className="text-2xl font-bold">Not Picked</h1> */}
      </div>
...
export default StaffNotPickedLeadsPage;
