...
export default function EarnDetailPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold tracking-tight">Earn Detail</h1>
            ...
            {loading ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                    <div className="lg:col-span-3">
                        <Card>
                            <CardHeader>
                                <CardTitle>Earn Plan Detail</CardTitle>
                            </CardHeader>
                            <CardContent>
        ...
        <Card className="shadow-lg rounded-2xl bg-primary text-primary-foreground">
            <CardContent className="p-6 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <p className="text-xl font-bold">Total Earn</p>
                </div>
