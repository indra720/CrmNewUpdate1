...
export default function PendingFollowupsPage() {
  ...
  async function fetchLeads() {
    try {
      ...
      const data = await getTeamCustomersByTag('pending_follow', formattedStartDate, formattedEndDate);
      setLeads(data.leads || []);
  ...
  const handleExport = async () => {
    try {
      ...
      const payload = {
        status: 'pending_followups', // Correct status for this page
                                  ...
                                  <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                                    ...
                                    <div className="overflow-hidden">
                                      <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border-t border-gray-200">
                                        ...
                                        <div className="p-3 border-b border-r md:border-r-0 border-gray-200 flex items-center justify-between md:justify-start md:gap-4">
                                          <div className="flex items-center">
                                            <CalendarIcon className="h-4 w-4 mr-3 text-gray-500 flex-shrink-0" />
